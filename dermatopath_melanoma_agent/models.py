"""
Clinical Data Models & Enums for DermatoPath Sentinel: Cutaneous Melanoma Microstaging & Margin Safety Agent.
...
class AgentAlert:
    ...
    guideline_citation: str = "AJCC 8th Edition & CAP Melanoma Protocol"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
